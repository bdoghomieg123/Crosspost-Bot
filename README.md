# Reddit Multi Purpose Cross Poster.

Hello! Welcome to the Reddit crosspost bot. As it was written in the init commit, it cross-posts the sticky'd posts from r/IndiaSpeaks to r/IndiaSpeaksTrending

This bot can be used as a shell for other developers to repurpose it for other things, and can easily be modified in its "as-is" code to be tailored to something else that you may want. There are comments in the code to explain what you can change
